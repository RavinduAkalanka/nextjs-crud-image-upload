...
export default function Haiku({ haiku }) {
  const { _id, line1, line2, line3, photo } = haiku;
  ...
  return (
    <div className="relative rounded-xl overflow-hidden max-w-[650px] mx-auto mb-7">
      ...
      <CldImage
        ...
        src={photo} // Ensure photo is a valid URL string
        sizes="750px"
      ...
      <div className="absolute bottom-2 right-2 flex">
        ...
        <form action={deleteHaiku}>
          <input
            name="id"
            type="hidden"
            defaultValue={haikuId} // Use the string version of _id
          />
